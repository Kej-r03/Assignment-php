...
if($_SESSION['SReg']==1)//if user has just registered
{
    echo "<script>alert(`Successfully registered`)</script>";
    $_SESSION['SReg']=0;
}

if($_SESSION['errSCred']==1)//if credentials are wrong, user is alerted
{
...
<html>
    ...
    <body>
        ...
        <a href="Student_create.php">Create new student</a>
